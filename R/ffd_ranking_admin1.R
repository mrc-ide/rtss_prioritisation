...
ranking <- function(scenario, vaccine_dose, vaccine_cov, constraint){
  ...
  # Save output
  filename <- paste0("processed_outputs_", scenario, "/ranking_admin1_", scenario, "_", vaccine_dose, "_", vaccine_cov, "_", constraint/1e6, ".csv")
...
write_csv(out, "processed_outputs/ranking_summary_all_admin1.csv")
