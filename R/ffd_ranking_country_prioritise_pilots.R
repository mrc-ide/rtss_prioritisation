...
ranking <- function(scenario, vaccine_dose, vaccine_cov, constraint){
  ...
  # Save output
  filename <- paste0("processed_outputs_", scenario, "/GKM_ranking_country_", scenario, "_", vaccine_dose, "_", vaccine_cov, "_", constraint_start/1e6, ".csv")
...
write_csv(out, "processed_outputs/GKM_ranking_summary_all_country.csv")
