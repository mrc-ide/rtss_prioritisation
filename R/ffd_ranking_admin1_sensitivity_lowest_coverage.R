...
get_data <- function(scenario, vaccine_dose, vaccine_cov){
  data <- read_csv(paste0("modelled_events/impact_5y_mean_events_averted_admin1_", scenario, "_lowest_coverage.csv"), col_types = "iccddddc")
