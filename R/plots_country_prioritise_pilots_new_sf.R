...
create_shp0_data <- function(s, vc, vd){
  ...
  shp_join$vaccine_cov <- recode(shp_join$vaccine_cov, "full_coverage" = "100% vaccine coverage", "reduced_coverage" = "Realistic vaccine coverage")
  shp_join$schedule <- recode(shp_join$schedule, "4_dose" = "4 doses", "3_dose" = "3 doses")
...
save_plot("results/S3_Fig_newsf.tiff", map, ncol = 2, nrow = 2, base_height = 3.7, base_width = 3.7)
